...
{    
    ...
    content += clickLat + ", " + clickLng + "<br /><br />";
   for (var i = 0;i < supporters.length;i++)
   {
       if (i == 0)
       {
           content += "<span style='color:red'>Leader</span><br />";
       }
       if (i == 1)
       {
           content += "<br /><span style='color:red'>Other</span><br />";
       }
       content += "<span style='color:yellow'>" + supporters[i][1] + "</span> - " + supporters[i][6] + "<br />";
   }

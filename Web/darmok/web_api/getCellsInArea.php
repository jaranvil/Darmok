...
$query = "SELECT * FROM Cell WHERE lat > (".$lat."-0.1) AND lat < (".$lat."+0.1) AND lng > (".$lng."-0.1) AND lng < (".$lng."+0.1)";
...
$query2 = "SELECT * FROM CellSupport ".
        ...
        "WHERE lat > (".$lat."-0.1) AND lat < (".$lat."+0.1) AND lng > (".$lng."-0.1) AND lng < (".$lng."+0.1) ORDER BY CellSupport.amount DESC";
